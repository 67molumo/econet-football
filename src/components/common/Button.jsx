...
const Button = ({
  ...
  const variants = {
    primary: 'bg-[#1a4d7a] text-white hover:bg-[#0f3460] focus:ring-2 focus:ring-[#1a4d7a] focus:ring-offset-2',
    ...
    outline: 'border-2 border-[#1a4d7a] text-[#1a4d7a] hover:bg-[#1a4d7a] hover:text-white',
  }
